...
class SlideWindow:
    ...
    def curve(self, img) :
        ...
        # pwin_l = 100
        # pwin_r = 580
        curve_img = img[365:470, 240:400] # 358
    ...
    def slidewindow(self, img, steering):
        ...
        win_h1 = 420
        win_h2 = 480
        win_l_w_l = 130 + min(steering * -5,30)
        win_l_w_r = 250 + min(steering * -5,30)
        win_r_w_l = 430 + min(steering * -5,30)
        win_r_w_r = 550 + min(steering * -5,30)
